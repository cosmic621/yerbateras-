export default function WhatsAppBtn() {
  return (
    <a
      ...
      onMouseEnter={e => { e.currentTarget.style.transform='scale(1.12)'; e.currentTarget.style.boxShadow='0 6px 24px rgba(37,211,102,0.55)'; }}
    ...
    >
      ...
      <style>{`@keyframes pulse-wa { 0%{transform:scale(1);opacity:0.8} 100%{transform:scale(1.7);opacity:0} }`}</style>
    </a>
  );
}
